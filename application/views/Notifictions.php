<div><div><div class="container">
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<h5 class="text-dark font-weight-bold my-1 mr-5">Notifications</h5>
										...
										<div class="card-toolbar">
											...
											<!--end::Dropdown-->
											<!--begin::Button-->
											<a href="<?php echo site_url('SendNewThemeNotification'); ?>" class="btn btn-primary font-weight-bolder">
											<span class="svg-icon svg-icon-md">
														...
														<div class="col-md-4 my-2 my-md-0">
															<div class="d-flex align-items-center">
																...
																<select class="form-control" id="kt_datatable_search_type">
																	<option value="">All</option>
																	<option value="0">Contractor App</option>
																	<option value="1">Wholsaler App</option>
																	<option value="2">Invoice Management</option>
																</select>
															</div>
														</div>
													</div>
