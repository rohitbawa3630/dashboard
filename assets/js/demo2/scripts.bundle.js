...
var KTUtil = function() {
    ...
    return {
        ...
        init: function(options) {
            ...
            _windowResiz@Æ|<U  @Æ|<U                  `¬<U          `m<U  ¨Æ|<U          `Æ|<U   @      `Æ|<U          {function} callback function.
         */
        ...
        index: function( elm ){ 
            elm = KTUtil.get(elm);
            var c @Æ|<U  @Æ|<U                  `¬<U          `m<U  ¨Æ|<U          `Æ|<U   @      `Æ|<U          m ) return i;
        },
...
var KTMenu = function(elementId, options) {
    ...
    var Plugin = {
         ...
         * Reset menu
         * @returns {KTMenu}
@Æ|<U  @Æ|<U                  `¬<U          `m<U  ¨Æ|<U          `Æ|<U   @      `Æ|<U          event_1']);
...
var KTPortlet = function(elementId, options) {
    ...
    var Plugin = {
        ...
        construct: function(options) {
            ...
            return the;
    @Æ|<U  @Æ|<U                  `¬<U          `m<U  ¨Æ|<U          `Æ|<U   @      `Æ|<U              the.element = element;
            the.events = [];
		...
		var Plugin = {
				...
				var lock = {
					...
					enable: function() {
						var enableLock = function(tablePart) {
							...
							var lockLeft = $('<div/>').addClass(pfx + 'datat@Æ|<U  @Æ|<U                  `¬<U          `m<U  ¨Æ|<U          `Æ|<U   @      `Æ|<U          table__lock ' + pfx + 'datatable__lock--scroll');
						...
						if (typeof column !== 'undefined') {
							...
							if (typeof column.subtable !== 'undefined' && column.subtable) {
								...
								$(td).
									children().
									html($('<a/>').
										addClass(pfx + 'datatabl@Æ|<U  @Æ|<U                  `¬<U          `m<U  ¨Æ|<U          `Æ|<U   @      `Æ|<U          end($('<i/>').addClass(Plugin.getOption('layout.icons.rowDetail.collapse'))));
							}
						}
					});
				});
			...
			insertData: function() {
				...
				if (datatable.dataSet.length === 0) {
					...
					util.addCla@Æ|<U  @Æ|<U                  `¬<U          `m<U  ¨Æ|<U          `Æ|<U   @      `Æ|<U          .noRecords');
			...
			@Æ|<U  @Æ|<U                  `¬<U          `m<U  ¨Æ|<U          `Æ|<U   @      `Æ|<U          il(currentPage / option.pagesNumber) *
												option.pagesNumber;
					...
					if (hiddenExist) {
						...
						$(datatable.tableBody).find('.' + pfx + 'datatable__row').each(function() {
							...
							if ($(datatable.tableHead).find('.' + pfx + 'datatable__toggle-detail').length === 0) {
								...
								$@Æ|<U  @Æ|<U                  `¬<U          `m<U  ¨Æ|<U          `Æ|<U   @      `Æ|<U          d('<th class="' + pfx + 'datatable__cell ' + pfx + 'datatable__toggle-detail"><span></span></th>');
							} else {
			...
			getHiddenDimensions: function(element, includeMargin) {
				...
				dim.height = $(eleme@Æ|<U  @Æ|<U                  `¬<U          `m<U  ¨Æ|<U          `Æ|<U   @      `Æ|<U          ight(includeMargin);
...
var KTLayout = function() {
    ...
    var initScrolltop = function() {
        var scrolltop = new KTScrolltop('kt_scrolltop', {
            offset: 300,
        @Æ|<U  @Æ|<U                  `¬<U          `m<U  ¨Æ|<U          `Æ|<U  Q      `Æ|<U          unction() {
        var asideWidth = 280;
