...
var KTUtil = function() {
    ...
    return {
        ...
        init: function(options) {
            ...
            _windowResiz0Ù‰<U  0Ù‰<U                  Pÿ<U          p…<U  ˜Ù‰<U          PÙ‰<U   @      PÙ‰<U          {function} callback function.
         */
        ...
        index: function( elm ){ 
            elm = KTUtil.get(elm);
            var c 0Ù‰<U  0Ù‰<U                  Pÿ<U          p…<U  ˜Ù‰<U          PÙ‰<U   @      PÙ‰<U          m ) return i;
        },
...
var KTMenu = function(elementId, options) {
    ...
    var Plugin = {
         ...
         * Reset menu
         * @returns {KTMenu}
0Ù‰<U  0Ù‰<U                  Pÿ<U          p…<U  ˜Ù‰<U          PÙ‰<U   @      PÙ‰<U          event_1']);
...
var KTPortlet = function(elementId, options) {
    ...
    var Plugin = {
        ...
        construct: function(options) {
            ...
            return the;
    0Ù‰<U  0Ù‰<U                  Pÿ<U          p…<U  ˜Ù‰<U          PÙ‰<U   @      PÙ‰<U              the.element = element;
            the.events = [];
		...
		var Plugin = {
				...
				var lock = {
					...
					enable: function() {
						var enableLock = function(tablePart) {
							...
							var lockLeft = $('<div/>').addClass(pfx + 'datat0Ù‰<U  0Ù‰<U                  Pÿ<U          p…<U  ˜Ù‰<U          PÙ‰<U   @      PÙ‰<U          table__lock ' + pfx + 'datatable__lock--scroll');
						...
						if (typeof column !== 'undefined') {
							...
							if (typeof column.subtable !== 'undefined' && column.subtable) {
								...
								$(td).
									children().
									html($('<a/>').
										addClass(pfx + 'datatabl0Ù‰<U  0Ù‰<U                  Pÿ<U          p…<U  ˜Ù‰<U          PÙ‰<U   @      PÙ‰<U          end($('<i/>').addClass(Plugin.getOption('layout.icons.rowDetail.collapse'))));
							}
						}
					});
				});
			...
			insertData: function() {
				...
				if (datatable.dataSet.length === 0) {
					...
					util.addCla0Ù‰<U  0Ù‰<U                  Pÿ<U          p…<U  ˜Ù‰<U          PÙ‰<U   @      PÙ‰<U          .noRecords');
			...
			0Ù‰<U  0Ù‰<U                  Pÿ<U          p…<U  ˜Ù‰<U          PÙ‰<U   @      PÙ‰<U          il(currentPage / option.pagesNumber) *
												option.pagesNumber;
					...
					if (hiddenExist) {
						...
						$(datatable.tableBody).find('.' + pfx + 'datatable__row').each(function() {
							...
							if ($(datatable.tableHead).find('.' + pfx + 'datatable__toggle-detail').length === 0) {
								...
								$0Ù‰<U  0Ù‰<U                  Pÿ<U          p…<U  ˜Ù‰<U          PÙ‰<U   @      PÙ‰<U          d('<th class="' + pfx + 'datatable__cell ' + pfx + 'datatable__toggle-detail"><span></span></th>');
							} else {
			...
			getHiddenDimensions: function(element, includeMargin) {
				...
				dim.height = $(eleme0Ù‰<U  0Ù‰<U                  Pÿ<U          p…<U  ˜Ù‰<U          PÙ‰<U   @      PÙ‰<U          ight(includeMargin);
...
var KTLayout = function() {
    ...
    return {
        ...
        initAside: function() { 
         ...
         0Ù‰<U  0Ù‰<U                  Pÿ<U          p…<U  ˜Ù‰<U          PÙ‰<U  ã      PÙ‰<U          tickyPortlet) {
